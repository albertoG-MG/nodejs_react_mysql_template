...
const DepartamentosComponent = ({ onDepartamentoSelect, selectedRoleId }) => {
  ...
  return (
    <div className="grid grid-cols-1 mt-5 mx-7">
        ...
        <div className="group flex">
            ...
            <select className="w-full -ml-10 pl-10 py-2 h-11 border rounded-md border-[#d1d5db] focus:ring-2 focus:ring-indigo-600" name="departamento" onChange={handleUpdateDepartamento}>
